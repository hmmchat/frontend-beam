...
export default function GiftModal({ isOpen, onClose, onSelectGift }) {
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white font-[family-name:var(--font-outfit)]">Add Gift</h2>
          </div>
