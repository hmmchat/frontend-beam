...
export default function Inbox() {
  ...
  return (
    <div className="h-screen w-full relative text-white font-sans overflow-hidden">
      ...
      {/* Page Container */}
      <div className="h-full flex flex-col md:py-12 md:px-12 lg:px-24 md:max-w-6xl md:mx-auto relative z-10">
        ...
        {/* Main Card */}
        <div variant="outline" className="flex-1 w-full md:h-[78vh] md:border-4 border-white/50 md:rounded-2xl md:rounded-3xl overflow-hidden flex flex-col md:flex-row bg-transparent">
          ...
          >
            <h2 className="hidden md:block text-lg md:text-xl font-semibold mb-4 ">Chats</h2>
            ...
            <input
              placeholder="Search"
              className="mb-4 mx-4 md:mx-0 w-auto md:w-full bg-black/30 border border-white/50 focus:border-white/50 rounded-xl px-4 py-3 text-sm placeholder-white/50"
            />
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 md:p-6 border-b border-white/20 bg-black/20 md:bg-transparent">
              <div className="flex items-center gap-3">
                <button
