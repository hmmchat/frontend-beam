...
export default function MeetSomeoneNew({
  ...
  return (
    <div className="relative h-[100vh] w-full overflow-hidden flex flex-col">
      ...
      {mode !== 'squad' && (
        <div
          className="absolute inset-0 z-[2] mt-3 mb-24 flex items-center justify-center pointer-events-none"
      ...
      <div className="flex flex-col py-8">
        ...
        <div className="relative   z-10 flex-1 w-full max-w-xl mx-auto px-3 flex flex-col items-center justify-center gap-4">
          ...
          <div className="w-full mt-[6%] relative py-10 px-0">
      ...
      <div className=" mb-[14%] absolute bottom-[25.2%]    z-40 pointer-events-none  w-[94%]  ms-auto  ">
      ...
      <div className=" absolute bottom-[58.2%]  left-0 w-[96%] ms-auto z-40 pointer-events-none  flex items-center justify-center  ">
      ...
      <div className=" absolute bottom-[12%]  left-0 w-full z-40 pointer-events-none z-10 w-full max-w-sm px-4 mx-auto ">
