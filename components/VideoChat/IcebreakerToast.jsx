...
export default function IcebreakerToast({ isOpen, icebreaker, className }) {
  if (!isOpen) return null;

  return (
    <div className={clsx(
      'absolute top-[49%] right-[15%] z-40 animate-in fade-in slide-in-from-top-4 flex justify-end md:top-[78%] md:right-[54%]',
      className,
    )}>
