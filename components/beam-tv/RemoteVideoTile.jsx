      ...
      {isFirst && (
        <div className="absolute top-4 left-5 right-5 flex items-start justify-between z-10">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-4 bg-[#C7BCB1]/80 backdrop-blur-2xl px-3 py-2 rounded-[2.5rem] border border-white/30 shadow-xl min-w-[200px] max-w-[320px]">
              <ParticipantCluster participants={allParticipants.length > 0 ? allParticipants : [{ userId: 'self', displayPictureUrl }]} />
              <div className="flex flex-col pr-4 overflow-hidden">
                <span className="text-white text-base font-extrabold tracking-tight leading-tight truncate">
                ...
                {allParticipants.length > 1 && (
                  <span className="text-[10px] text-white/70 font-bold uppercase tracking-wider mt-0.5">
                    Beamcasting Live
                  </span>
                )}
              </div>
