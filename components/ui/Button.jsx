...
export default function Button({
  ...
  const variantClasses = {
    ...
    outline2: " bg-transparent text-white hover:bg-purple-500/20 hover:border-purple-500 hover:-translate-y-0.5 border-white/50 rounded-[1.2rem] md:border-[2px] md:border-b-4 border-[1px] border-b-[3px]  ",
  }
