...
export default function FilterButtons({ 
  ...
  return (
    <div className={`font-[family-name:var(--font-otomanopee)] border border-white/90 flex flex-row items-center justify-center gap-0  md:w-[50%] mx-auto border border-white/30 rounded-[16px] overflow-hidden ${className}`}>
      <button
