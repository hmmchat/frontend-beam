...
export default function FilterButtons({ 
  ...
  return (
    <div className={`font-[family-name:var(--font-otomanopee)] flex flex-row items-center justify-center gap-0 w-[80%] mx-auto border border-white/30 rounded-[20px] overflow-hidden bg-black/30 ${className}`}>
      <button
