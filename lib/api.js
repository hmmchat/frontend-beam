...
export const API = {
    ...
    DISCOVERY: {
        ...
        LOCATION_PREFERENCE: `${DISCOVERY_SERVICE_URL}/discovery/location-preference`,
        UPDATE_LOCATION_PREFERENCE: `${DISCOVERY_SERVICE_URL}/discovery/location-preference`,
        SEARCH_CITIES: (q) => `${DISCOVERY_SERVICE_URL}/discovery/cities/search?q=${encodeURIComponent(q)}`,
        GET_CITIES: `${DISCOVERY_SERVICE_URL}/discovery/cities`,
        GET_INTERESTS: `${USER_SERVICE_URL}/interests`,
        GET_VALUES: `${USER_SERVICE_URL}/values`,
        GET_BRANDS: `${USER_SERVICE_URL}/brands`,
    ...
    STREAMING: {
        ...
        CREATE_ROOM: `${STREAMING_SERVICE_URL}/streaming/rooms`,
        // NOTE: POST /streaming/rooms/:roomId/end does NOT exist in production backend.
        // The backend only exposes test/rooms/:roomId/end and test/rooms/:roomId/leave.
        // Room lifecycle is primarily managed via WebSocket 'leave-room' message.
        // These test endpoints are safe to call from frontend in production too.
        END_ROOM: (roomId) => `${STREAMING_SERVICE_URL}/streaming/test/rooms/${roomId}/end`,
        LEAVE_ROOM: (roomId) => `${STREAMING_SERVICE_URL}/streaming/test/rooms/${roomId}/leave`,
